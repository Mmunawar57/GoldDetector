...
class Digital_meter_fragment : Fragment(), SensorEventListener {
    ...
    private val binding by lazy {
        FragmentDigitalMeterFragmentBinding.inflate(layoutInflater)
    }
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?,
    ): View? {
       AppLivin_BannerAds.loadBannerAd(requireContext(),binding.framelayoutAds)
        initView()
        return binding.root
    }
